...
This repository contains the source code for the **MCU Peripheral Drivers** development project. Visit the "MCU Peripheral Drivers" section on my website for more details: [https://jackklee.com/mcu-peripheral-drivers](https://jackklee.com/mcu-peripheral-drivers).
...
* Please see the [https://jackklee.com/portfolio/lcd-digital-clock](https://jackklee.com/portfolio/lcd-digital-clock) project to observe how these drivers are utilized in a real-world embedded systems project
